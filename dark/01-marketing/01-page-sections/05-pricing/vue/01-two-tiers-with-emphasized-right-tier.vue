<template>
  <div class="relative isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
    <div class="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl" aria-hidden="true">
      <div
        class="mx-auto aspect-1155/678 w-288.75 bg-linear-to-tr from-[#ff80b5] to-[#9089fc] opacity-20"
        style="
          clip-path: polygon(
            74.1% 44.1%,
            100% 61.6%,
    ...
    <div
      ...
      <div
        ...
        <h3 :id="tier.id" :class="[tier.featured ? 'text-indigo-400' : 'text-indigo-400', 'text-base/7 font-semibold']">
          {{ tier.name }}
        </h3>
        ...
        <ul
          ...
          <li v-for="feature in tier.features" :key="feature" class="flex gap-x-3">
            <CheckIcon
              :class="[tier.featured ? 'text-indigo-400' : 'text-indigo-400', 'h-6 w-5 flex-none']"
              aria-hidden="true" />
            {{ feature }}
          </li>
        </ul>
